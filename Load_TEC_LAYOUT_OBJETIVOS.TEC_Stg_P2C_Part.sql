-- RUNCATE TABLE `primal-sunup-357522.TEC_LAYOUT_OBJETIVOS.TEC_Stg_P2C_Part`;
 ...
 WHEN REGEXP_CONTAINS(C.CAMPAIGN, r'(?i)(TEST)') THEN 'TEST_Alkemy'
  ELSE 'RESTO'
    END)
        ...
        WHEN C.CAMPAIGN LIKE '%BRAND%' AND C.CAMPAIGN_TYPE = 'Google' THEN 'SEM BRAND'
 ...
 WHEN REGEXP_CONTAINS(CL.CAMPAIGN, r'(?i)(TEST)') THEN 'TEST_Alkemy'
  ELSE 'RESTO'
    END)
        ...
        WHEN CL.CAMPAIGN LIKE '%BRAND%' AND CL.CAMPAIGN_TYPE = 'Google' THEN 'SEM BRAND'
 ...
 WHEN REGEXP_CONTAINS(IM.CAMPAIGN, r'(?i)(TEST)') THEN 'TEST_Alkemy'
  ELSE 'RESTO'
    END)
        ...
        WHEN IM.CAMPAIGN LIKE '%BRAND%' AND IM.CAMPAIGN_TYPE = 'Google' THEN 'SEM BRAND'
